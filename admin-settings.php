...
function yka_sendy_settings_init()
{
    ...
    add_settings_field(
        'yka_sendy_url',
        __('Sendy Installation Url', 'wordpress'),
        'yka_sendy_url_render',
        'yka_sendy_group',
        'yka_sendy_section'
    );
}
...
?>
    ...
    <input type='checkbox' name='yka_sendy_settings[yka_sendy_signup_sync]' value="1" <?php checked($options['yka_sendy_signup_sync'], 1); ?> />
<?php
...
function yka_sendy_signup_list_render()
{
    ...
    <input type='text' name='yka_sendy_settings[yka_sendy_signup_list]' value='<?php isset($options['yka_sendy_signup_list']) ? _e($options['yka_sendy_signup_list']) : ''; ?>'>
<?php
...
function yka_sendy_api_key_render()
{
    ...
    <input type='text' name='yka_sendy_settings[yka_sendy_api_key]' value='<?php isset($options['yka_sendy_api_key']) ? _e($options['yka_sendy_api_key']) : ''; ?>'>
<?php
...
function yka_sendy_url_render()
{
    $options = get_option('yka_sendy_settings'); ?>

    <input type='text' name='yka_sendy_settings[yka_sendy_url]' value='<?php isset($options['yka_sendy_url']) ? _e($options['yka_sendy_url']) : ''; ?>'>
    <p class="description">eg:- https://newsletters.mydomain.com</p>
<?php
}
